        ...
        <div class="card-img-overlay d-flex flex-column">
         <div class="card-body">
          ...
          <form action="kartlar.php" method="POST" class="form">
              <div id="check"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class=" mx-auto bi bi-check-circle-fill" viewBox="0 0 16 16">
